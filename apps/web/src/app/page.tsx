...
export const metadata: Metadata = {
  ...
  description:
    'Leading staffing agency in Kingston, Jamaica. We place registered nurses, LPNs, geriatric nurses, doctors, babysitters, and housekeepers with top employers and families. Call or WhatsApp: (876) 561-9970 / (876) 561-9856.',
  openGraph: {
    title: 'Healthcare & Domestic Staffing Agency in Jamaica | Weir Here Staffing',
    description:
